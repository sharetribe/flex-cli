...
## [v1.17.1] - 2026-09-25
- Print validation error details [#124](https://github.com/sharetribe/flex-cli/pull/124)

## [v1.17.0] - 2026-08-31

- Add support for `:action/update-protected-files` action. [#122](https://github.com/sharetribe/flex-cli/pull/122)
