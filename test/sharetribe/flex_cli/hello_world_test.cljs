...
(deftest search-schema-tests
  (let
   [response {:data [{:dataSchema/key :hobbies,
    ...
    (io-util/print-table
     ...
     (#'search-schema/extract-rows response))
    (assert/called-once? sharetribe.flex-cli.api.client/do-get)
    ))
